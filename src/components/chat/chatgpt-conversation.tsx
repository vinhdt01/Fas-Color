   ...
   useEffect(() => {
    ...
    return (
      ...
      <div ref={bottomRef} />
               ...
               <form onSubmit={handleSubmit}  className="w-full flex items-center mb-[10px] bg-[#f7eded] rounded-b-lg py-[10px] px-[10px]">
                    ...
                    <button type="submit" className="h-[40px] w-[40px] bg-[#5d5cde] rounded-full p-[5px]">
