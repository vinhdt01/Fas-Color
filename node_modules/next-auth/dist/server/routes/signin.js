...
async function signin(req, res) {
  ...
  if (provider.type === "oauth" && req.method === "POST") {
    ...
    let email = (_req$body$email$toLow = (_req$body$email = req.body.email) === null || _req$body$email === void 0 ? void 0 : _req$body$email.toLowerCase()) !== null && _req$body$email$toLow !== void 0 ? _req$body$email$toLow : null;
