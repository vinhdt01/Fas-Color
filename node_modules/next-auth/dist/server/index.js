...
async function NextAuthHandler(req, res, userOptions) {
  ...
  return new Promise(async resolve => {
    var _userOptions$pages$er, _userOptions$pages, _req$query, _userOptions$useSecur, _req$cookies, _cookies$callbackUrl$, _cookies$callbackUrl, _provider$version, _userOptions$adapter;
    ...
    const errorPage = (_userOptions$pages$er = (_userOptions$pages = userOptions.pages) === null || _userOptions$pages === void 0 ? void 0 : _userOptions$pages.error) !== null && _userOptions$pages$er !== void 0 ? _userOptions$pages$er : `${baseUrl}${basePath}/error`;
    const callbackUrlParam = (_req$query = req.query) === null || _req$query === void 0 ? void 0 : _req$query.callbackUrl;
    ...
    } = cookie.defaultCookies((_userOptions$useSecur = userOptions.useSecureCookies) !== null && _userOptions$useSecur !== void 0 ? _userOptions$useSecur : baseUrl.startsWith("https://"));
    const callbackUrlCookie = (_req$cookies = req.cookies) === null || _req$cookies === void 0 ? void 0 : _req$cookies[(_cookies$callbackUrl$ = cookies === null || cookies === void 0 ? void 0 : (_cookies$callbackUrl = cookies.callbackUrl) === null || _cookies$callbackUrl === void 0 ? void 0 : _cookies$callbackUrl.name) !== null && _cookies$callbackUrl$ !== void 0 ? _cookies$callbackUrl$ : defaultCallbackUrl.name];
