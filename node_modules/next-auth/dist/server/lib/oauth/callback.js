  ...
  if ((_provider$version = provider.version) !== null && _provider$version !== void 0 && _provider$version.startsWith("2.")) {
    ...
    if (req.method === "POST") {
      try {
        ...
        _logger.default.debug("OAUTH_CALLBACK_HANDLER_ERROR", req.body);
    ...
    try {
      ...
      _logger.default.error("OAUTH_GET_ACCESS_TOKEN_ERROR", error, provider.id);
...
async function getProfile({
  ...
  try {
    ...
    _logger.default.error("OAUTH_PARSE_PROFILE_ERROR", exception);
